...
export function UserMenu() {
  ...
  <div className="relative" ref={menuRef}>
    ...
    {open && (
      <div className="absolute right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-200 z-[100]">
        <div className="px-4 py-3 border-b border-gray-100">
          <div className="font-semibold text-gray-900">Mi perfil</div>
          <div className="text-sm text-gray-500">{userEmail || 'No autenticado'}</div>
        </div>
